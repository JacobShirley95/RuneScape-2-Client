...
public class Class170_Sub3_Sub1 extends SoftwareSprite {

   int[] colourData;


   Class170_Sub3_Sub1(SoftwareRenderer var1, int[] var2, int var3, int var4, int var5, int var6, boolean var7) {
      ...
      for(int var9 = 0; var9 < var6; ++var9) {
         for(int var10 = 0; var10 < var5; ++var10) {
            this.colourData[var8++] = var2[var3++];
         }
   ...
   Class170_Sub3_Sub1(SoftwareRenderer var1, int[] var2, int var3, int var4) {
   ...
   public void drawAt(int var1, int var2, int var3, int var4, int var5) {
      if(this.renderer.method6820()) {
         ...
         if(var6 != null) {
            ...
            if(var1 + var11 > this.renderer.targetY * 1163141991) {
               var14 = var1 + var11 - this.renderer.targetY * 1163141991;
               var11 -= var14;
               var13 += var14;
               var12 += var14;
            }
               ...
               if(var5 == 0) {
                  if(var3 == 1) {
                     for(var14 = -var10; var14 < 0; ++var14) {
                        for(var15 = var8 + var11 - 3; var8 < var15; var6[var8++] = this.colourData[var9++]) {
                           var6[var8++] = this.colourData[var9++];
                           var6[var8++] = this.colourData[var9++];
                           var6[var8++] = this.colourData[var9++];
                        }

                        for(var15 += 3; var8 < var15; var6[var8++] = this.colourData[var9++]) {
                           ;
                        }
   ...
   public void method2142(int var1, int var2, Class1024 var3, int var4, int var5) {
      if(this.renderer.method6820()) {
         ...
         if(var6 != null) {
            ...
            if(var9 > 0 && var10 > 0) {
               Class1024_Sub3 var29 = (Class1024_Sub3)var3;
               int[] var15 = var29.anIntArray_10982;
               int[] var16 = var29.anIntArray_10981;
               int var17 = var2;
               if(var5 > var2) {
                  var17 = var5;
   ...
   Class170_Sub3_Sub1(SoftwareRenderer var1, int var2, int var3) {
         ...
         if(anInt_10927 == 0) {
            if(anInt_10928 == 0) {
               ...
               for(var6 = anInt_10926; var6 < 0; anInt_10912 += anInt_10925) {
                  ...
                  if(var7 >= 0) {
                     ...
                     if(var9 >= 0 && var9 - (this.width << 12) < 0) {
                        if((var19 = var10 - (this.height << 12)) >= 0) {
                           var19 = (anInt_10928 - var19) / anInt_10928;
                           var11 += var19;
                           var10 += anInt_10928 * var19;
                           var8 += var19;
                        }

                        if((var19 = (var10 - anInt_10928) / anInt_10928) > var11) {
                           var11 = var19;
                        }
               ...
               for(var6 = anInt_10926; var6 < 0; anInt_10912 += anInt_10925) {
                  ...
                  if(var7 >= 0) {
                     ...
                     if(var9 >= 0 && var9 - (this.width << 12) < 0) {
                        if(var10 < 0) {
                           var19 = (anInt_10928 - 1 - var10) / anInt_10928;
                           var11 += var19;
                           var10 += anInt_10928 * var19;
                           var8 += var19;
                        }

                        if((var19 = (1 + var10 - (this.height << 12) - anInt_10928) / anInt_10928) > var11) {
                           var11 = var19;
                        }
               ...
               for(var6 = anInt_10926; var6 < 0; anInt_10912 += anInt_10925) {
                  ...
                  if(var7 >= 0) {
                     ...
                     if(var10 >= 0 && var10 - (this.height << 12) < 0) {
                        if((var19 = var9 - (this.width << 12)) >= 0) {
                           var19 = (anInt_10927 - var19) / anInt_10927;
                           var11 += var19;
                           var9 += anInt_10927 * var19;
                           var8 += var19;
                        }

                        if((var19 = (var9 - anInt_10927) / anInt_10927) > var11) {
                           var11 = var19;
                        }
            ...
            for(var6 = anInt_10926; var6 < 0; anInt_10912 += anInt_10925) {
               ...
               if(var7 >= 0) {
                  ...
                  if(var10 >= 0 && var10 - (this.height << 12) < 0) {
                     if(var9 < 0) {
                        var19 = (anInt_10927 - 1 - var9) / anInt_10927;
                        var11 += var19;
                        var9 += anInt_10927 * var19;
                        var8 += var19;
                     }

                     if((var19 = (1 + var9 - (this.width << 12) - anInt_10927) / anInt_10927) > var11) {
                        var11 = var19;
                     }
   ...
   void method1323(int var1, int var2, int[] var3, int var4, int var5) {
      int var6;
      int var7;
      int var8;
      int var9;
      ...
      if(var5 == 0) {
         ...
         if(var5 == 1) {
            if(var4 == 1) {
               ...
               var6 = this.colourData[var1];
               var7 = (var6 >>> 24) * anInt_10938 >> 8;
               var8 = 256 - var7;
               if((anInt_10937 & 16777215) == 16777215) {
                  var9 = var3[var2];
                  var3[var2] = ((var6 & 16711935) * var7 + (var9 & 16711935) * var8 & -16711936) + ((var6 & '\uff00') * var7 + (var9 & '\uff00') * var8 & 16711680) >> 8;
               } else if(var7 != 255) {
                  var9 = (var6 & 16711680) * anInt_10932 & -16777216;
                  var10 = (var6 & '\uff00') * anInt_10941 & 16711680;
                  var11 = (var6 & 255) * anInt_10942 & '\uff00';
                  var6 = (var9 | var10 | var11) >>> 8;
                  var12 = var3[var2];
                  var3[var2] = ((var6 & 16711935) * var7 + (var12 & 16711935) * var8 & -16711936) + ((var6 & '\uff00') * var7 + (var12 & '\uff00') * var8 & 16711680) >> 8;
               } else {
                  var9 = (var6 & 16711680) * anInt_10932 & -16777216;
                  var10 = (var6 & '\uff00') * anInt_10941 & 16711680;
                  var11 = (var6 & 255) * anInt_10942 & '\uff00';
                  var3[var2] = (var9 | var10 | var11) >>> 8;
               }
            } else if(var4 == 3) {
               var6 = this.colourData[var1];
               var7 = anInt_10937;
               ...
               var11 = (var6 >>> 24) * anInt_10938 >> 8;
               var12 = 256 - var11;
               if(var11 != 255) {
                  var6 = var10;
                  var10 = var3[var2];
                  var10 = ((var6 & 16711935) * var11 + (var10 & 16711935) * var12 & -16711936) + ((var6 & '\uff00') * var11 + (var10 & '\uff00') * var12 & 16711680) >> 8;
               }
               ...
               var7 = var6 >>> 24;
               var8 = 256 - var7;
               var9 = (var6 & 16711935) * anInt_10938 & -16711936;
               var10 = (var6 & '\uff00') * anInt_10938 & 16711680;
               var6 = ((var9 | var10) >>> 8) + anInt_10943;
               var11 = var3[var2];
               var3[var2] = ((var6 & 16711935) * var7 + (var11 & 16711935) * var8 & -16711936) + ((var6 & '\uff00') * var7 + (var11 & '\uff00') * var8 & 16711680) >> 8;
            }
         } else {
            if(var5 != 2) {
               throw new IllegalArgumentException();
            ...
            if(var4 == 1) {
               ...
               var10 = var3[var2];
               var11 = var6 + var10;
               var12 = (var6 & 16711935) + (var10 & 16711935);
            ...
            if(anInt_10928 == 0) {
               for(var4 = anInt_10926; var4 < 0; anInt_10912 += anInt_10925) {
                  ...
                  if(var6 >= 0 && var7 >= 0 && var6 - (this.width << 12) < 0 && var7 - (this.height << 12) < 0) {
                     while(var8 < 0) {
                        this.method1323((var7 >> 12) * this.width + (var6 >> 12), var5++, var3, var1, var2);
                        ++var8;
                     }
                  }
      ...
      if(var7 == null) {
         ...
         for(int var8 = 0; var8 < var4; ++var8) {
            ...
            for(int var11 = 0; var11 < var3; ++var11) {
               this.colourData[var9 + var11] = var7[var10 + var11] & 16777215;
            }
         }
   ...
   public void method2128(int var1, int var2, int var3) {
      int[] var4 = this.renderer.renderArray;
      if(var4 == null) {
         throw new IllegalStateException("");
      } else {
         int var5;
         ...
         if(var3 == 0) {
            for(var5 = 0; var5 < this.height; ++var5) {
               var6 = var5 * this.width;
               var7 = (var2 + var5) * this.renderer.renderWidth * 1176497263 + var1;

               for(var8 = 0; var8 < this.width; ++var8) {
                  this.colourData[var6 + var8] = this.colourData[var6 + var8] & 16777215 | var4[var7 + var8] << 8 & -16777216;
               }
            }
         } else if(var3 == 1) {
            for(var5 = 0; var5 < this.height; ++var5) {
               ...
               for(var8 = 0; var8 < this.width; ++var8) {
                  this.colourData[var6 + var8] = this.colourData[var6 + var8] & 16777215 | var4[var7 + var8] << 16 & -16777216;
               }
            }
         } else if(var3 == 2) {
            for(var5 = 0; var5 < this.height; ++var5) {
               ...
               for(var8 = 0; var8 < this.width; ++var8) {
                  this.colourData[var6 + var8] = this.colourData[var6 + var8] & 16777215 | var4[var7 + var8] << 24 & -16777216;
               }
            }
         } else if(var3 == 3) {
            for(var5 = 0; var5 < this.height; ++var5) {
               ...
               for(var8 = 0; var8 < this.width; ++var8) {
                  this.colourData[var6 + var8] = this.colourData[var6 + var8] & 16777215 | (var4[var7 + var8] != 0?-16777216:0);
               }
            }
         }
